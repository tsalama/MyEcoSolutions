...
$quote_address  = $_POST['quote_address'];
...
$address = "support@trestleautomation.com";
...
$e_body = "You have been contacted by $name for the Quick Quotation, their information is below:" . PHP_EOL . PHP_EOL;
$e_content = "\"They are located at: $quote_address\"" . PHP_EOL . PHP_EOL;
